...
class ScrollingTimestampPlot(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        list_of_files = glob.glob('/home/flyranch/field_data_and_analysis_scripts/2021lab/others/*.txt') ### By KH 4/22 
        latest_file = max(list_of_files, key=os.path.getctime)
        print(latest_file)
        self.datafile=latest_file
    ...
    def plot_updater(self):
        ...
        self.scrolling_timestamp_plot.setData(x=[item['x'] for item in self.data], y=[item['y'] for item in self.datafile])
